...
<div class="p-4 sm:ml-64 bg-gray-100 min-h-screen">
    ...
    <div class="p-4 mt-14">
            ...
            <div class="container max-w-screen-lg md:col-span-2 lg:col-span-1">
                <div class="md:flex md:items-center md:justify-between mb-3 bg-white rounded-lg shadow-md p-4 lg:w-full lg">
                    ...
                    <div class="mt-6 md:mt-0 pb-3 md:pb-0 lg:pb-0">
                        <a href="{{ route('user.edit' , $user->username) }}" class="text-white text-center bg-green-500 shadow-md hover:bg-green-600 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5  focus:outline-none  transition duration-200">Ubah Data</a>
                    </div>
                </div>
                @if (is_null($user->alamat) && is_null($user->nohp) && is_null($user->tgllahir) && is_null($user->pekerjaan) && is_null($user->jeniskelamin))
                <div class="flex items-center  p-4 mb-4 text-sm text-red-800 border border-red-300 rounded-lg bg-red-50  w-full" role="alert">
        ...
        @else
        <div class="flex items-center lg:w-1/2 p-4 mb-4 text-sm text-red-800 border border-red-300 rounded-lg bg-red-50  w-full" role="alert">
            <svg class="flex-shrink-0 inline w-4 h-4 me-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                <path d="M10 .5a9.5 9.5 0 1 0 9.5 9.5A9.51 9.51 0 0 0 10 .5ZM9.5 4a1.5 1.5 0 1 1 0 3 1.5 1.5 0 0 1 0-3ZM12 15H8a1 1 0 0 1 0-2h1v-3H8a1 1 0 0 1 0-2h2a1 1 0 0 1 1 1v4h1a1 1 0 0 1 0 2Z" />
            </svg>
