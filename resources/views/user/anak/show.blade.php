...
<div class="p-4 sm:ml-64 bg-gray-100 min-h-screen">
    ...
    <div class="px-2 pt-4 mt-14">
        <a href="{{ route('user.show', $user->username) }}" class="inline-flex items-center justify-center p-2 mb-5 text-base font-medium text-gray-500 rounded-lg shadow-md bg-gray-50 hover:bg-gray-100 ">
