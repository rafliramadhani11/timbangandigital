                ...
                <div class="flex items-center ms-3">
                    <div>
                        ...
                        <button type="button" class="text-gray-500 mx-5
                            hover:bg-gray-200 dark:focus:ring-gray-700 rounded-lg text-sm p-1.5 transition duration-200" aria-expanded="false" data-dropdown-toggle="dropdown-user">
                            <span class="sr-only">Open user menu</span>
                            <div class="relative w-8 h-8 overflow-hidden bg-gray-100 rounded-full cursor-pointer dark:bg-gray-600" type="button">
                    ...
                    <!-- Dropdown menu -->
                    <div id="dropdown-user" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 dark:divide-gray-600">
                        @cannot('admin')
