<aside id="sidebar" class="fixed top-0 left-0 z-20 flex-col flex-shrink-0 hidden w-full h-full pt-16 font-normal duration-75 lg:w-64 lg:flex transition-width" aria-label="Sidebar">
    <div class="relative flex flex-col flex-1 min-h-0 pt-0 bg-white border-r border-gray-200 dark:bg-gray-800 dark:border-gray-700">
        <div class="flex flex-col flex-1 px-3 pt-3 pb-4">
            <div class="flex-1 px-3 space-y-1 bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                <ul class="pb-2 space-y-2">
                    <!-- DASHBOARD -->
                    <li>
                        <x-nav-link class="flex w-full" :href="route('user.index')" :active='request()->routeIs("user.index")'>
                            <svg class="w-6 mr-3  h-6 text-gray-500 transition duration-75 svg-icon group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white
                    ...
                    <!-- PROFILE -->
                    <li>
                        <x-nav-link class="flex w-full" :href="route('user.show', $user->username)" :active='request()->routeIs("user.show")'>
                            <svg class="w-6 mr-3  h-6 text-gray-500 transition duration-75 svg-icon group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white
                            {{ Request::is('dashboard/user/*')? 'text-gray-900 dark:text-gray-400' : '' }}" fill="currentColor" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg">
