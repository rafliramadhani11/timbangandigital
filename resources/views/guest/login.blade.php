...
<div class="flex h-screen ">
    ...
    <div class="items-center justify-center flex-1 hidden text-black bg-white lg:flex">
        <div class="max-w-3xl text-center ">
            <img src="{{ asset('img/login.png') }}" alt="" class="object-contain">
        </div>
    </div>
    <!-- Right Pane -->
    <div class="flex items-center justify-center w-full bg-gray-100 lg:w-1/2">
        <div class="w-full max-w-md p-6">
            ...
            <div id="alert-2" class="flex items-center justify-start px-4 py-2 text-red-800 bg-red-100 rounded-lg " role="alert">
                <svg class="flex-shrink-0 w-4 h-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                    <path d="M10 .5a9.5 9.5 0 1 0 9.5 9.5A9.51 9.51 0 0 0 10 .5ZM9.5 4a1.5 1.5 0 1 1 0 3 1.5 1.5 0 0 1 0-3ZM12 15H8a1 1 0 0 1 0-2h1v-3H8a1 1 0 0 1 0-2h2a1 1 0 0 1 1 1v4h1a1 1 0 0 1 0 2Z" />
                </svg>
                <small class="font-semibold ms-3">
                    {{ session('failedLogin') }}
                </small>
            ...
            <div id="alert-3" class="flex items-center p-3 mb-4 text-green-800 bg-green-100 rounded-lg dark:bg-gray-800 dark:text-green-400" role="alert">
                <svg class="flex-shrink-0 w-4 h-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                    <path d="M10 .5a9.5 9.5 0 1 0 9.5 9.5A9.51 9.51 0 0 0 10 .5ZM9.5 4a1.5 1.5 0 1 1 0 3 1.5 1.5 0 0 1 0-3ZM12 15H8a1 1 0 0 1 0-2h1v-3H8a1 1 0 0 1 0-2h2a1 1 0 0 1 1 1v4h1a1 1 0 0 1 0 2Z" />
                </svg>
            ...
            <form action="{{ route('authlogin') }}" method="post" class="space-y-4">
                ...
                <div>
                    ...
                    <input type="text" name="username" class="block w-full px-3 pt-2 mt-1 text-sm text-black bg-white border rounded-md shadow-sm placeholder-slate-400 focus:outline-none focus:border-orange-400 focus:ring-1 focus:ring-orange-400" placeholder="johndee1234" value="{{ old('username') }}" autofocus required />
                </div>
                <div class="relative">
                    <span class="block text-sm font-medium text-slate-700 ">Password</span>
                    <input type="password" id="password" name="password" class="block w-full p-2 mt-1 text-sm text-black bg-white border rounded-md shadow-sm placeholder-slate-400 focus:outline-none focus:border-orange-400 focus:ring-1 focus:ring-orange-400" required>
