<x-guest-layout>
    ...
    <!-- component -->
    <div class="h-screen flex lg:grid lg:grid-cols-2">
        <!-- Right Pane -->
        <div class="flex items-center justify-center w-full bg-gray-100 ">
            <div class="w-full max-w-md p-6">
                <h1 class="mb-6 text-3xl font-semibold text-center text-black">Daftar Akun</h1>
                <h1 class="mb-6 text-sm font-semibold text-center text-gray-500">Langkah Pertama Menuju Pengukuran Presisi: Daftar Sekarang di Web Timbangan Digital Kami !</h1>
