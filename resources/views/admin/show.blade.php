...
<div class="p-4 sm:ml-64 bg-gray-100 min-h-screen">
    ...
    <div class="px-2 pt-4 mt-14">
        ...
        <a href="{{ route('admin.users') }}" class="inline-flex items-center justify-center p-2 mb-5 text-base font-medium text-black rounded-lg shadow-md bg-gray-50 hover:bg-gray-100 dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700 dark:hover:text-white">
        ...
        <div class="md:grid md:grid-cols-2 md:gap-5">
                    ...
                    <div class="grid grid-cols-1 gap-4 text-sm gap-y-2">
                        <div class="md:flex md:items-center md:justify-between mb-5">
                            ...
                            <div class="mt-5 md:mt-0">
                                <a href="{{ route('admin.edit' , $user->username) }}" class="text-white text-center bg-green-500 shadow-md hover:bg-green-600 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 mt-4 dark:bg-green-600 dark:hover:bg-green-700 focus:outline-none dark:focus:ring-green-800">Ubah Data</a>
                            </div>
                        </div>
            ...
            <!-- CREATE ANAK -->
            <div class='container max-w-screen-lg md:col-span-2 lg:col-span-1'>
                <div class="p-4 px-4 mb-6 bg-white rounded-lg shadow-md dark:bg-gray-800 md:p-8 lg:h-[25.5rem] ">
                    ...
                    <form method="post" action="{{ route('admin.anak.store', $user->username) }}">
                        ...
                        <button type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 mt-4 w-full lg:w-1/4 focus:ring-blue-300 font-medium rounded-lg shadow-md text-sm px-5 py-2.5 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800 transition duration-200">
                            Buat Baru
                        </button>
                    </form>
                </div>
        ...
        <div class=" p-4 overflow-x-auto shadow-md rounded-lg bg-white">
            ...
            @else
            <div class="flex items-center w-full lg:w-1/2 md:w-full p-4 mb-4 text-sm text-red-800 border border-red-300 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400 dark:border-red-800" role="alert">
