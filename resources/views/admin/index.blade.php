        ...
        <div class="gap-10 lg:grid lg:grid-cols-3">
            ...
            <div class="p-4  mb-6 bg-white rounded-lg shadow-md dark:bg-gray-800 md:p-8">
                <div class="md:flex md:items-center md:justify-between">
                    ...
                    <a class="focus:outline-none text-white bg-[#00A688]  focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-green-600  dark:focus:ring-green-800">
                        NORMAL
                    </a>
                </div>
                <div>
