...
function fuzzy_imt_usia($usia, $imt, $isMale)
{
    ...
    $wasted = new FuzzySet("wasted", [10.15, 13.05], "low_membership_function");
    $normal = new FuzzySet("normal", [11.1, 19.7], "medium_membership_function");
    $obesitas = new FuzzySet("resiko obesitas", [17.9, 21.6], "high_membership_function");
...
function fuzzy_bb_usia($usia, $bb, $isMale)
{
    ...
    $obesitas = new FuzzySet("resiko obesitas", [4.9, 13.2], "high_membership_function");
